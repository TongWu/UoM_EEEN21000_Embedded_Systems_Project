...
%             my_alg('wR_desired') = my_alg('wR_desired')*0.7;  
%              my_alg('wL_desired') = my_alg('wL_desired')*0.7;
%         elseif my_alg('right encoder')<4 && my_alg('left encoder')<4
%             my_alg('wR_desired') = my_alg('wR_desired')*1.2;  
%              my_alg('wL_desired') = my_alg('wL_desired')*1.2;
%         end
